...
document.getElementById('add-webhook-btn').addEventListener('click', () => {
    document.getElementById('webhook-form-title').textContent = 'New Webhook';
    document.getElementById('webhook-form').style.display = 'flex';
...
document.getElementById('close-webhook-form').addEventListener('click', () => {
    document.getElementById('webhook-form').style.display = 'none';
});
